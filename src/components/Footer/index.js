    ...
    <div className="footer-wrapper" id="footer">		
		  <div className="footer-container" />
			...
			<div class="footer-inner-left">
				<div class="footer-email">E-Mail <a href="mailto:office@rmdatagroup.com"><strong>office@rmdatagroup.com</strong></a></div>
